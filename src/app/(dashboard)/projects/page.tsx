    ...
    <div className="max-w-5xl space-y-6">
      <div className="flex items-center justify-between gap-2">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold text-zinc-100">Projects</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <Badge variant="outline" className="text-xs border-zinc-700 text-zinc-500 mt-0.5">
                          {project.key}
                        </Badge>
                      </div>
                    </div>
        ...
        <NewProjectDialog trigger={
          <button className="border-2 border-dashed border-zinc-800 rounded-xl p-5 flex flex-col items-center justify-center gap-2 hover:border-zinc-700 hover:bg-zinc-900/50 transition-colors cursor-pointer min-h-[140px] w-full">
