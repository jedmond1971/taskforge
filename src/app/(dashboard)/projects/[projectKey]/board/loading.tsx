      ...
      <div className="flex gap-4">
        {Array.from({ length: 4 }).map((_, col) => (
          <div key={col} className="flex-shrink-0 w-72 space-y-2">
            <div className="bg-zinc-900 border border-zinc-800 rounded-t-lg px-3 py-2.5">
              <Skeleton className="h-5 w-24" />
            </div>
            <div className="bg-zinc-900 border border-t-0 border-zinc-800 rounded-b-lg p-2 space-y-2 min-h-[120px]">
