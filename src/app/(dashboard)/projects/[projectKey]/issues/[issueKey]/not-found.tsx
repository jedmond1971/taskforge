...
export default function IssueNotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 p-8 text-center">
      ...
      <div>
        <h2 className="text-xl font-bold text-zinc-100 mb-1">Issue not found</h2>
        <p className="text-sm text-zinc-500">This issue may have been deleted or you don&apos;t have access.</p>
      </div>
      <Link href="../../issues" className="text-sm text-indigo-400 hover:text-indigo-300 transition-colors">
        ← Back to issues
      </Link>
    </div>
  );
