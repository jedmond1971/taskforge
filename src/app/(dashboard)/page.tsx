...
const statusConfig = {
  TODO: { label: "To Do", color: "bg-zinc-700 text-zinc-300", icon: Clock },
  IN_PROGRESS: { label: "In Progress", color: "bg-indigo-900/50 text-indigo-300", icon: Clock },
  IN_REVIEW: { label: "In Review", color: "bg-amber-900/50 text-amber-300", icon: AlertCircle },
  DONE: { label: "Done", color: "bg-emerald-900/50 text-emerald-300", icon: CheckCircle2 },
} as const;

const priorityConfig = {
  CRITICAL: { label: "Critical", color: "bg-red-900/50 text-red-300" },
  HIGH: { label: "High", color: "bg-orange-900/50 text-orange-300" },
  MEDIUM: { label: "Medium", color: "bg-yellow-900/50 text-yellow-300" },
  LOW: { label: "Low", color: "bg-zinc-700 text-zinc-400" },
} as const;
        ...
        <Card className="bg-zinc-900 border-zinc-800">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-zinc-100">{assignedIssues.length}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-zinc-900 border-zinc-800">
          <CardHeader className="pb-3">
            <CardTitle className="text-base font-semibold text-zinc-100">Your Projects</CardTitle>
          </CardHeader>
              ...
              projects.map((project) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-zinc-100 group-hover:text-white">{project.name}</p>
        ...
        <Card className="bg-zinc-900 border-zinc-800">
          <CardHeader className="pb-3">
            <CardTitle className="text-base font-semibold text-zinc-100">Assigned to You</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2">
                ...
                return (
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      <p className="text-sm text-zinc-100 truncate">{issue.title}</p>
