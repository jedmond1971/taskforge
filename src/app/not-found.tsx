...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen gap-4 bg-stone-50 dark:bg-zinc-950 text-center p-8">
      ...
      <div>
        ...
        <p className="text-zinc-500 dark:text-zinc-400 mb-1">Page not found</p>
